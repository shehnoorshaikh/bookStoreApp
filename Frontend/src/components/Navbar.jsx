      ...
      : "bg-base-100"
        ...
        <div className="navbar shadow-sm">
          <div className="navbar-start">
            ...
            <a className="text-2xl font-bold cursor-pointer text-base-content">bookStore</a>
          </div>
          <div className="navbar-end space-x-3">
            ...
            <div className="hidden md:block text-base-content">
            ...
            <div>
              <a className="btn-primary text-white px-3 py-2 rounded-md bg-black duration-300 cursor-pointer" onClick={()=>document.getElementById('my_modal_3').showModal()}>Login</a>
            <Login />
            </div>
          </div>
        </div>
